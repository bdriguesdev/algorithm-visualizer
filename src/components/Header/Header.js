                    ...
                    <li onMouseEnter={openOrCloseMenu} onMouseLeave={openOrCloseMenu} className="link">
                        ...
                        <div style={{ display: isSortMenuOpen? 'block': 'none' }} className="sortMenu">
                            <ul>
                                ...
                                <li onMouseEnter={() => menuHover('#FF165D', 'heap', 'normal')} onMouseLeave={() => menuHover('#FF165D', 'heap', 'reverse')} id="heap" className="sortLink">
                                ...
                                <li onMouseEnter={() => menuHover('#FF9A00', 'merge', 'normal')} onMouseLeave={() => menuHover('#FF9A00', 'merge', 'reverse')} id="merge" className="sortLink">
                                ...
                                <li onMouseEnter={() => menuHover('#3EC1D3', 'quick', 'normal')} onMouseLeave={() => menuHover('#3EC1D3', 'quick', 'reverse')} id="quick" className="sortLink">
